...
import com.example.truckers.databinding.ActivityBusinessregisBinding
...
class businessregis : AppCompatActivity() {
    ...
    lateinit var binding: ActivityBusinessregisBinding
    lateinit var database: DatabaseReference
    lateinit var auth:FirebaseAuth
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=ActivityBusinessregisBinding.inflate(layoutInflater)
